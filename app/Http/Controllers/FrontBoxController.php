...
class FrontBoxController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('front_box.edit', compact('categorias', 'abertura', 'funcionarios', 'item', 'cliente', 'funcionario', 
            'caixa', 'isVendaSuspensa', 'tiposPagamento', 'config'));
    }
