            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card widget-icon-box div-pagamento" style="height: 93%">
                        <div class="card-body">
                            <div class="">
                                <button type="button" class="btn btn-sm btn-warning w-100 btn-pagamento-multi" data-bs-toggle="modal" data-bs-target="#pagamento_multiplo"><i class="ri-list-check-3"></i> Pagamento múltiplo</button>
